...
final class LogUtil
{
  private static final Logger c_logger =
    "console".equals( ArezTableConfig.loggerType() ) ? new ConsoleLogger() :
    "proxy".equals( ArezTableConfig.loggerType() ) ? new ProxyLogger() :
    new NoopLogger();
   ...
   */
  @OmitType( unless = "arez.table.logger=console" )
   ...
   */
  @OmitType( unless = "arez.table.logger=proxy" )
